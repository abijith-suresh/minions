  ...
  const verification = spawnSync(
    ...
    [
      ...
      [
        ...
        'if (agents.minions.mode !== "primary") process.exit(1)',
        'if (agents.minions.permission.task["*"] !== "deny") process.exit(1)',
        'if (agents.minions.permission.task["minions-worker"] !== "allow") process.exit(1)',
        'if (agents["minions-worker"].hidden !== true) process.exit(1)',
        'if (agents["minions-worker"].permission.task !== "deny") process.exit(1)',
        'if (agents.minions.model || agents["minions-worker"].model) process.exit(1)',
      ].join("\n"),
    ],
