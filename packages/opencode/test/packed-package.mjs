  ...
  const verification = spawnSync(
    ...
    [
      ...
      [
        ...
        "if (agents.minions) process.exit(1)",
        'if (agents.minion.mode !== "subagent") process.exit(1)',
        "if (agents.minion.hidden !== true) process.exit(1)",
        'if (agents.minion.permission.task !== "deny") process.exit(1)',
        "if (agents.minion.model) process.exit(1)",
      ].join("\n"),
    ],
